...
> 从单 ETF 绝对信号升级为「相对强弱 × 趋势阶段 × 量能验证 × 基准对比」四维评估。
...
| **整固** | RSI>70持续3天以上，或高位缩量 | 持有但不追，回撤风险升高 |
| **衰竭** | RSI从70+快速回落至50以下 + 成交量萎缩 | 降权提醒，关注趋势失效风险 |
| **机会流失** | 均线破位 + MACD死叉 + RSI<40（同日满足） | 趋势失效提示，建议降权观察 |
